...
real(dbl) ctrl_init_salinity
real(dbl) ctrl_eps_exit_salinity
...
integer maxit
real(dbl) s, eps, sea_sa_si, t_si, p_si, d_si
...
integer it, maxit
real(dbl) salinity_iteration, t_si, p_si, d_si, s, eps
real(dbl) ds, dv, gs_p, gs_sp
