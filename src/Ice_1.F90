...
complex(dbl), private :: tk(2), rk1, rk2(3)
real(dbl), private :: g0(10),s0,tt,pt,pnorm,p0
...
implicit none
real(dbl) ice_g, t, p, tn, pn
complex(dbl) sr(2),term(2)
integer i
...
implicit none
real(dbl) ice_d2gdtdp, t, p, tn, pn
integer i
complex(dbl) sr(2),term(2)
...
implicit none
real(dbl) ice_d3gdt2dp, t, p, tn, pn
complex(dbl) sr(2),term(2)
integer i
...
implicit none
real(dbl) ice_d3gdtdp2, t, p, tn, pn
complex(dbl) sr(2),term(2)
