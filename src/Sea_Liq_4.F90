...
real(dbl), private :: ctrl_init_d_liq, ctrl_eps_exit_p
...
real(dbl), private :: equi_sea_liq_d_liq, equi_sea_liq_d_sea, equi_sea_liq_s, &
...
implicit none
real(dbl) sea_liq_osmoticpressure_si, sa_si, t_si, p_si
...
integer maxit
real(dbl) set_sea_liq_eq_at_s_t_p, sa_si, t_si, p_liq_si
real(dbl) eps
real(dbl) d_liq
real(dbl) d_sea, p_sea
...
real(dbl) sea_liq_iteration_at_s_t_d, sa_si, t_si, d_liq_si, eps, d_sea_si, p_sea_si
real(dbl) p, d, dd
real(dbl) mus, p_old
real(dbl) gl, gw
real(dbl) gs_p, gs_sp
