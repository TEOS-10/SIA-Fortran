...
real(dbl),  private :: n0i(9), n1i(34), nri(43)
...
real(dbl) fit_liq_density_if97_si
real(dbl) t_si, p_si
real(dbl) d
...
real(dbl) fit_vap_density_if97_si
real(dbl) t_si, p_si
real(dbl) d
...
integer i, j
real(dbl) p, t, d(3)
real(dbl) g(3), g_t(3), g_tt(3), g_tp(3), g_p(3), g_pp(3)
real(dbl) chooset(3), choosep(3)
