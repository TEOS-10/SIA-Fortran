...
real(dbl) liq_air_h_si, wa_si, eta_si, p_si
real(dbl) t
...
real(dbl) liq_air_h_cp_si, wa_si, eta_si, p_si
real(dbl) t
...
real(dbl) liq_air_h_density_si, wa_si, eta_si, p_si
real(dbl) t
...
real(dbl) liq_air_h_kappa_s_si, wa_si, eta_si, p_si
real(dbl) d, c
...
real(dbl) liq_air_h_lapserate_si, wa_si, eta_si, p_si
...
real(dbl) liq_air_h_temperature_si, wa_si, eta_si, p_si
real(dbl) t1, t2, eps
integer maxit
...
real(dbl) liq_air_potdensity_si, a_si, t_si, p_si, pr_si
real(dbl) s, v
...
real(dbl) liq_air_potenthalpy_si, a_si, t_si, p_si, pr_si
real(dbl) s
...
real(dbl) liq_air_pottemp_si, a_si, t_si, p_si, pr_si
real(dbl) s
...
real(dbl) temperatureiteration_brent, wa_si, eta_si, p_si, t1, t2, eps
real(dbl) a, b, c, d, s
...
real(dbl) liq_air_a_eta_p_derivatives_si, wa_si, t_si, p_si
...
real(dbl) aux_temperature_max_si, wa_si, p_si, error_flag
...
real(dbl) aux_temperature_min_si, wa_si, p_si
